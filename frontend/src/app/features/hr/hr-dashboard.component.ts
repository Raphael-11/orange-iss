      ...
      <aside class="dashboard-sidebar">
        ...
        <nav class="sidebar-nav">
          <div class="nav-section">
            <div class="nav-section-title">HR Portal</div>
            <div class="nav-item">
              <a routerLink="/hr" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}" class="nav-link">
            ...
            <div class="nav-item">
              <a routerLink="/hr/offers" routerLinkActive="active" class="nav-link">
            ...
            <div class="nav-item">
              <a routerLink="/hr/applications" routerLinkActive="active" class="nav-link">
            ...
            <div class="nav-item">
              <a routerLink="/hr/candidates" routerLinkActive="active" class="nav-link">
            ...
            <div class="nav-item">
              <a routerLink="/hr/reports" routerLinkActive="active" class="nav-link">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>
                Reports
              </a>
            </div>
            <div class="nav-item">
              <a routerLink="/hr/profile" routerLinkActive="active" class="nav-link">
